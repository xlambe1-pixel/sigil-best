...
const collections = [
  {name:'Ethereal Voids', status:'live', price:'0.12', items:'777', slug:'ethereal-voids', bg:'#0c0818', accent:'#5b21b6'},
  {name:'Quantum Masks', status:'live', price:'0.03', items:'2,000', slug:'quantum-masks', bg:'#0d1520', accent:'#1e3a5f'},
  {name:'Pale Signals', status:'soon', price:'—', items:'500', slug:'pale-signals', bg:'#0e0820', accent:'#6d28d9'},
]
            ...
            <div style={{position:'relative',borderRadius:'11px',overflow:'hidden',cursor:'pointer',background:c.bg,height:'100%'}}>
              ...
              <div style={{position:'absolute',bottom:0,left:0,right:0,padding:'1rem'}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'10px',fontFamily:'DM Mono,monospace',fontSize:'10px',color:'rgba(255,255,255,.35)'}}>
                  ...
                  {c.price!=='—' && <span style={{color:'#a5a0ff'}}>{c.price} RITUAL</span>}
