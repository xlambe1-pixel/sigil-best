    ...
    <div style={{maxWidth:'720px',margin:'0 auto',padding:'2.5rem 1.75rem'}}>
      ...
      {step===1 && (
        <div>
          ...
          <div style={{background:'#0f0f14',border:'.5px solid rgba(255,255,255,.07)',borderRadius:'10px',padding:'1rem 1.25rem',marginBottom:'2rem'}}>
            <div style={{fontFamily:'DM Mono,monospace',fontSize:'10px',color:'rgba(255,255,255,.25)',letterSpacing:'.08em',marginBottom:'.75rem'}}>// metadata format</div>
            <div style={{fontFamily:'DM Mono,monospace',fontSize:'11px',color:'rgba(124,111,247,.7)',lineHeight:2}}>
              {`{`}<br/>
              &nbsp;&nbsp;<span style={{color:'rgba(255,255,255,.4)'}}>"name"</span>: <span style={{color:'#4ade80'}}>"Collection #0001"</span>,<br/>
              &nbsp;&nbsp;<span style={{color:'rgba(255,255,255,.4)'}}>"description"</span>: <span style={{color:'#4ade80'}}>"..."</span>,<br/>
              &nbsp;&nbsp;<span style={{color:'rgba(255,255,255,.4)'}}>"image"</span>: <span style={{color:'#4ade80'}}>"ipfs://..."</span>,<br/>
              &nbsp;&nbsp;<span style={{color:'rgba(255,255,255,.4)'}}>"attributes"</span>: [...]<br/>
              {`}`}
            </div>
          </div>
      ...
      {step===3 && (
        <div>
          ...
          <div style={{background:'rgba(124,111,247,.06)',border:'.5px solid rgba(124,111,247,.2)',borderRadius:'8px',padding:'.85rem 1rem',marginBottom:'1.5rem',fontFamily:'DM Mono,monospace',fontSize:'11px',color:'rgba(124,111,247,.8)',lineHeight:1.8}}>
            deploying will create a smart contract on ritual testnet. make sure your wallet is connected and has enough RITUAL for gas fees (~0.01 RITUAL).
          </div>
          <div style={{display:'flex',gap:'.75rem'}}>
            ...
            <button style={{background:'#7c6ff7',border:'none',color:'#080809',fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:'13px',padding:'.7rem 2rem',borderRadius:'7px',cursor:'pointer',letterSpacing:'.04em'}}>
              🔮 deploy collection
            </button>
          </div>
        </div>
